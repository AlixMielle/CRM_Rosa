    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-2">
                <h1 class="h3 mb-0 text-gray-800">Détilas entreprise</h1>
            </div>
            <div class="row">
                    ...
                    <div class="card shadow">
                        <div class="card-body profile-card">
                            <center class="mt-4"> <img
                                ...
                                <h4 class="card-title mt-2">Company name</h4>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <h5 class="my-3">123 456 789 0059</h5>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <h5 class="my-3">Company@email.com</h5>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12 mb-0">Numéro de téléphone fixe</label>
                                    <div class="col-md-12">
                                        <h5 class="my-3">123 456 7893</h5>
                                    </div>
                                </div>
                                <div class="form-group">
