...
<head>
    ...
    <title>EasyToTask | Editer entreprise</title>
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-2">
                <h1 class="h3 mb-0 text-gray-800">Editer entreprise</h1>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="siret" placeholder="123 456 789 00056"
                                               class="form-control ps-0 form-control-line" name="example-siret"
                                               id="example-siret">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Secteur"
                                               class="form-control ps-0 form-control-line">
                                    </div>
                                </div>
