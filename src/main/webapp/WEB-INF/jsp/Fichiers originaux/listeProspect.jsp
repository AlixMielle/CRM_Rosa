    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Prospects enregitrés</h4>
                            <div class="table-responsive">
                                <table class="table user-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="border-top-0">Téléphone fixe</th>
                                        <th class="boder-top-0">Téléphone portable</th>
                                        <th class="boder-top-0">Etat de la prospection</th>
                                        <th class="border-top-0">Date de création</th>
                                        <th class="border-top-0">Détails du prospect</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
        ...
        <div class="form-group m-2 p-2">
            <div class="col-sm-12 d-flex p-2">
                <button class="btn btn-success mx-auto text-white" type="submit">Ajouter un prospect</button>
                <button class="btn btn-success mx-auto text-white" type="submit">Rechercher un prospect</button>
            </div>
        </div>
    </div>
</div>
