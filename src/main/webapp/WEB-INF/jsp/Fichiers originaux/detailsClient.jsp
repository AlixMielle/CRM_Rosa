        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-2">
                    <h1 class="h3 mb-0 text-gray-800">Détails prospect</h1>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <h5 class="my-3">Evènement</h5>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <h5 class="my-3">Mail</h5>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Numéro de téléphone fixe</label>
                                        <div class="col-md-12">
                                            <h5 class="my-3">Numéro</h5>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <h5 class="my-3">Code postal</h5>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Date de création</label>
                                        <h5 class="my-3">Date</h5>
                                    </div>
