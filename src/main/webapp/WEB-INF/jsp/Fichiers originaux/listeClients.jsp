        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Clients enregitrés</h4>
                                    ...
                                    <table class="table user-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="boder-top-0">Statut</th>
                                                <th class="border-top-0">Date de création</th>
                                                <th class="border-top-0">Détails du client</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
            ...
            <div class="form-group m-2 p-2">
                <div class="col-sm-12 d-flex p-2">
                    <button class="btn btn-success mx-auto text-white" type="submit">Ajouter un client</button>
                    <button class="btn btn-success mx-auto text-white" type="submit">Rechercher un client</button>
                </div>
            </div>
        </div>
    </div>
