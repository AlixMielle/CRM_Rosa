...
<head>
    ...
    <title>EasyToTask | Editer client</title>
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-2">
                <h1 class="h3 mb-0 text-gray-800">Editer client</h1>
            </div>
            <div class="row">
                    ...
                    <div class="card shadow">
                        <div class="card-body profile-card">
                            <center class="mt-4"> <img
                                ...
                                <h6 class="card-subtitle">Poste</h6>
                    ...
                    <div class="card shadow mb-5">
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 mb-0">Statut</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12">Sélectionner une entreprise</label>
                                    <div class="col-sm-12 border-bottom">
                                        <select class="form-select shadow-none ps-0 border-0 form-control-line">
                                            <option>DoesandDeers</option>
                                            <option>DoesandDeers</option>
                                            <option>DoesandDeers</option>
                                            <option>DoesandDeers</option>
                                            <option>DoesandDeers</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Cdde postal"
                                               class="form-control ps-0 form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
