                ...
                <ul id="sidebarnav" style="background-color: #1D4851;">
                    ...
                    <li>
                        <a href="#" class="nav-link align-items-center" style="color: #fff">
                            ...
                            <span class="ms-1 d-none d-sm-inline">Gestion entreprises</span></a>
                    </li>
                    ...
                    <li>
                        <a href="#" data-bs-toggle="collapse" class="nav-link align-items-center"
                           style="color: #fff">
                            ...
                            <span class="ms-1 d-none d-sm-inline">Gestion clients</span> </a>
                    </li>
                    ...
                    <li>
                        <a href="#" class="nav-link align-items-center" style="color: #fff">
                            ...
                            <span class="ms-1 d-none d-sm-inline">Gestion prospects</span> </a>
                    </li>
        ...
        <div class="container-fluid">
            ...
            <footer class="text-center footer-expand-md fixed-bottom" style="background-color: #F3F3F3;">
                <div class="p-3 container-fluid d-inline-block">
                    ...
                    <p class="mb-1 text-center"><fmt:formatDate value="${now}" pattern="yyyy"/> &copy; EasyToTask !</p>
