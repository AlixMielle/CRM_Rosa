            ...
            <div class="row navbar-brand d-flex align-items-center justify-content-around">
                ...
                <div class="col-10">
                    <form action="${pageContext.request.contextPath}/enterprises/all/sorted"
                          class="navbar-brand d-flex justify-content-between">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <button type="submit" class="btn btn-sm btn-outline-secondary"><i class="bi bi-sort-alpha-down"></i></button>
                            </div>
                        </div>
                    </form>
                    <form action="${pageContext.request.contextPath}/enterprises/all/resorted"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <button type="submit" class="btn btn-sm btn-outline-secondary"><i class="bi bi-sort-alpha-up"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
