    ...
    <section id="section1" class="container-fluid">
                ...
                <div class="form-outline mb-4">
                    ...
                    <div class="col-sm-12 mb-1">
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-sm" name="pictureFile" id="pictureFile" type="file" required="" >
        ...
        <div class="form-group m-2 p-2">
            <div class="col-sm-12 d-flex p-2">
                ...
                <button type="submit" class="btn btn-light mx-auto text-white" style="background-color: darkslategray">Créer
                </button>
                <button type="reset" class="btn btn-light mx-auto text-white" style="background-color: darkslategray">Annuler</button>
            </div>
        </div>
